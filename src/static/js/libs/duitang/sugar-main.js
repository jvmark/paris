  ...
  return {
    PopOut : function (){
      return {
        ...
        STR : [
          '<a href="javascript:;" target="_self" class="abtn l" onclick="SUGAR.PopOut.closeMask();"><button type="button"><u>关闭</u></button></a>', // 0 关闭按钮
          '<a href="javascript:;" target="_self" class="abtn l" onclick="SUGAR.PopOut.closeMask();"><button type="button"><u>取消</u></button></a>' // 1 取消按钮
        ],
        ...
        */
        alert : function (pm,n,opt){
          var _t = this,
            ...
            n = n || 0, // 默认小号尺寸
            wd = _t.WD,
            $whouse = $.G.store();  // $.G.store()  可以创建  #win-house 节点
        ...
        */
        setCont : function (pm,n){
          ...
          // SUGAR.PopOut.alert('22') 和 SUGAR.PopOut.alert([null,'22']) 后者没有标题头
          $head = pm[0] == null ? '' : $('<div class="tt-s"><span>'+pm[0]+'</span><a class="mask-close" target="_self" href="javascript:;" onclick="SUGAR.PopOut.closeMask();">关闭</a></div>'),
        ...
        */
        ...
        closeMask : function (){
//					var _t = this,ps = _t.pops,j =  ps.length;
//					if( _t.closePopN(n) ){
//						_t.closePops();
//						$('#mask').css('display','none');
//					}
//					$('#mask-tmp')[0].innerHTML = '';
          $.unblockUI()
        }
      }
